...
},{"handlebars/lib/handlebars/base":6,"handlebars/lib/handlebars/runtime":7,"handlebars/lib/handlebars/utils":8}],10:[function(require,module,exports){
...
module.exports = api;
},{"./api/media":13,"./api/server":14}],13:[function(require,module,exports){
﻿"use strict";
...
},{"lodash":10,"q":11}],15:[function(require,module,exports){
...
},{"../models/Album":21,"./ApiCollection":16}],16:[function(require,module,exports){
...
},{"../lib/jquery-2.0.3.js":20,"../models/Artist":23,"backbone":3,"lodash":10}],17:[function(require,module,exports){
﻿var ApiCollection = require('./ApiCollection');
...
},{"../models/Artist":23,"./ApiCollection":16}],18:[function(require,module,exports){
﻿var ApiCollection = require('./ApiCollection');
...
},{"../models/Media":24,"./ApiCollection":16}],19:[function(require,module,exports){
﻿var Backbone = require('backbone')
  , _ = require('lodash')
...
},{"backbone":3,"lodash":10}],20:[function(require,module,exports){
/*!
...
function program3(depth0,data) {
  ...
  buffer += "﻿";
  stack1 = helpers['if'].call(depth0, depth0.isActive, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\r\n";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\" style=\"width: 75px;\"/>\r\n  <div class=\"media-body\">\r\n    <h4 class=\"media-heading\">\r\n      <a href=\"#\" class=\"album-link\" data-cid=\"";
